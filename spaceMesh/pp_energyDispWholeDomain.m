            ...
            while (neof)
                ...
                for pt = 1:numPoints
                    ...
                    if ((length(obj.factorDelU) < flag) || (abs(obj.factorDelU(flag)) < 1e-190))
                        ...
                        if (fidSc < 0)
                            em2a = contains(obj.folder, 'tau1ep16em2');
                            em2b = contains(obj.folder, 'tau1p16em2');
                            tau1ep16em2 = (em2a || em2b);
                            em3a = contains(obj.folder, 'tau1ep16em3');
                            em3b = contains(obj.folder, 'tau1p16em3');
                            tau1ep16em3 = (em3a || em3b);
%                            tau1ep16em2 = (contains(obj.folder, 'tau1ep16em2') || contains(obj.folder, 'tau1p16em2'));
%                            tau1ep16em3 = (contains(obj.folder, 'tau1ep16em3') || contains(obj.folder, 'tau1p16em3'));
                ...
                if (isBoundary)
                    ...
                    [obj.domainInteriorEdgesByFlagByFlag{flag}, crackAngleDeg, valid] = obj.domainInteriorEdgesByFlagByFlag{flag}.UpdateBySegment(Xs, delUsLocalCrd, TrcnLocCrds, delVsLocalCrd, interiorFracScalars);
                    if (valid)
                        if (obj.numAngleRanges > 0)
                            ...
                            [obj.domainInteriorEdgesByAngle{anglei}, crackAngleDeg, valid] = obj.domainInteriorEdgesByAngle{anglei}.UpdateBySegment(Xs, delUsLocalCrd, TrcnLocCrds, delVsLocalCrd, interiorFracScalars);
                        end
                    end
                end
                [buf, neof] = fscanf(fid, '%s', 1);
