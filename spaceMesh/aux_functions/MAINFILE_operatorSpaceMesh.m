...
if strcmp(opt,'-mesh') || strcmp(opt,'-both')
    ...
    if (uniSz > 0)
        ...
        for j = 1:uniSz
            ...
            for i = 1:runLength               
                plotSpaceMeshSerialNumber(serialNumbers{i}(j), modifyInput, fileNamesIn{i}{j}, runNames{i}{j}, runFolder{i}, outputPhysicsDirectory, printFinal);                
            end
            %========================================== 
            % 5/26/2017
        ...
        for cnf = configGen{s_serialStart}:configGen{s_serialStep}:configGen{s_serialEnd}
            [FIG,AX] = setDefaultPlotVisible(globalVisibility,'reset');
            plotSpaceMeshSerialNumber(cnf, modifyInput);
        end
    end
end
%..........................................................................
